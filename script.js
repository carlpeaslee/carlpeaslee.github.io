$(document).ready(function(){
	...
	$('.item').click(function() {
		var idRef = this.id
		var moreMate = $(this).parent().parent().siblings('#right').children('#'+idRef)
	...
	//this is what goes through each index and tells me the start dates

	$('div.item').each(function( index ) {
		console.log( index + ": " + $( this ).attr('data-start') );
	});
